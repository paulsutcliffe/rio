...
describe EventosController do
  ...
  describe "GET index" do
    it "assigns all eventos as @eventos" do
      ...
      assigns(:eventos).should eq([evento])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved evento as @evento" do
        ...
        post :create, {:evento => { "nombre" => "invalid value" }}, valid_session
        assigns(:evento).should be_a_new(Evento)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested evento" do
        evento = Evento.create! valid_attributes
        # Assuming there are no other eventos in the database, this
        # specifies that the Evento created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Evento.any_instance.should_receive(:update_attributes).with({ "nombre" => "MyString" })
        put :update, {:id => evento.to_param, :evento => { "nombre" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the evento as @evento" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Evento.any_instance.stub(:save).and_return(false)
        put :update, {:id => evento.to_param, :evento => { "nombre" => "invalid value" }}, valid_session
        assigns(:evento).should eq(evento)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the eventos list" do
      evento = Evento.create! valid_attributes
      delete :destroy, {:id => evento.to_param}, valid_session
      response.should redirect_to(eventos_url)
    end
  end
